...
HtmlElement += `
    <div class="item">
        <li>
            <div class="slider-info banner-view" style="background: url(`+web_config.thumbnail_url+data[i].thumbnail+`) no-repeat center;background-size: cover;background-position:top; ">
                <div class="banner-info">
                    <h3>`+data[i].orginalName+`</h3>
                    <a href="watch?`+data[i].fileName+`" class="play-view1">
                        <span style='margin-top:30px;' class="video-play-icon">
    ...
    for(var i = 0; i < data.length;i++){
        ...
        <div class="box16 mb-0">
            <a href="watch?`+data[i].fileName+`">
                <figure>
                    <img class="img-fluid" src="`+web_config.thumbnail_url+data[i].thumbnail+`" style="object-position:top;" alt="">
                </figure>
        ...
        <h3 class='custom-title-grid'> <a class="title-gd" href="watch?`+data[i].fileName+`">`+data[i].orginalName+` (`+data[i].movie_year+`)</a></h3>
...
for(var i = 0; i < data.length;i++){
    ...
    <div class="item vhny-grid">
        <div class="box16 list-movie-card-sub">
            ...
            <a href="watch?`+data[i].fileName+`">
            <figure>
                <img style="object-position:top;" class="img-fluid" src="`+web_config.thumbnail_url+data[i].thumbnail+`" alt="">
            </figure>
            <div class="box-content">
...
function FetchAllData(){
    fetch(web_config.api_url+"?movies_db")
